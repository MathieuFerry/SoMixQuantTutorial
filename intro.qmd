...
The full questionnaire of the survey is shown below. We will mainly use Sections 1, 2, 3A, 3B, 7, and 8 of the questionnaire.
...
For this workshop, we have additionally prepared four files to make your life easier to manipulate the survey, which you can access here [Data repository](https://forms.gle/tkBxwuPQtSvmfT9o7). You will need to provide a password (request password by email!). Download the files from this online folder. The folder contains a PDF of the questionnaire and a zipped folder which you can unzip on your computer. In the zipped folder, you will find four ".rds" files (R statistical files):
...
```{r}
#| eval: false
#Adjust the working directory with the path where your data are stored on your computer
